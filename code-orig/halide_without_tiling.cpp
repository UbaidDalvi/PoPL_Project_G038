...
int main() {
     Buffer<uint8_t> input =load_image("./Mona_Lisa.jpg");
    Var x, y, c;
    ...
    if (user_input == "bright") {
        ...
        save_image(output, "Mona_Lisa_bright_Halide.png");
    }
        ...
        save_image(output, "Mona_Lisa_gray_Halide.png");
    }
        ...
        Buffer<uint8_t> output=blur.realize({input.width(),input.height(),3});
        save_image(output,"Mona_Lisa_blur_Halide.jpg");
    }
    else {
